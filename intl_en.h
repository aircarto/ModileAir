#define INTL_LANG "EN"
#define INTL_PM_SENSOR "Weather station MobileAir"
...
const char INTL_CO2_SENSORS[] PROGMEM = "NO2 sensors";
...
const char INTL_ENVEANO2[] PROGMEM = "Envea Cairsens NO2 sensor";
...
const char INTL_NBIOT_SETTINGS[] PROGMEM = "NBIoT Settings";
...
const char INTL_LED_VALUE[] PROGMEM = "LED display values";
const char INTL_LED_CONNECT[] PROGMEM = "LED display connection";
