...
#define SSID_BASENAME "mobileair-"
#define HOSTNAME_BASE "mobileair-"

#define LEN_CFG_STRING 65
#define LEN_CFG_PASSWORD 65
#define LEN_CFG_PASSWORD2 65
#define LEN_CFG_PASSWORD_NBIOT_JSON 65
#define LEN_CFG_PASSWORD_NBIOT_BYTE 65
#define LEN_CFG_STRING2 65
#define LEN_CFG_PASSWORD2 65

#define LEN_PAYLOAD_LORA 48
#define LEN_PAYLOAD_NBIOT 48
...
#define LEN_HOST_NBIOT_JSON 100
#define LEN_URL_NBIOT_JSON 100
#define LEN_USER_NBIOT_JSON 65
#define MAX_PORT_DIGITS_NBIOT_JSON 5
#define LEN_HOST_NBIOT_BYTE 100
#define LEN_URL_NBIOT_BYTE 100
#define LEN_USER_NBIOT_BYTE 65
#define MAX_PORT_DIGITS_NBIOT_BYTE 5
...
constexpr const unsigned long SAMPLETIME_NPM_MS_1MIN = 60000;
constexpr const unsigned long SAMPLETIME_NPM_MS_10SEC = 10000;
